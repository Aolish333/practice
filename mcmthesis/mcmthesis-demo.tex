...
\begin{document}
% =================================正文设置=======================================
\input{paper/abstract} % 模板自带的摘要
%\newgeometry{left=2.5cm,right=2.5cm}
\input{paper/ControlSheet} % 控制页及摘要 
...
% =================================子文件夹设置====================================
% 在子文件夹下编写文件
\input{paper/Introduction} % 介绍
\input{paper/AnalysisofOverallandKeyPoints} % 模型的分析
\input{paper/AssumptionsAndJustification}  % 假设
\input{paper/SymbolsAndDefinitions} %符号设置
\input{paper/Models} % 模型
\input{paper/Conclusions} % 结论
\input{paper/EvaluateOfTheMode} % 灵敏度分析
\input{paper/StrengthsAndWeaknesses}
\input{paper/FutureImprovements} %进一步提高
