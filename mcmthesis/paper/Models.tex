...
\noindent In order to evaluate the linguistic influence more reasonably, we have been inspired by reference\upcite{influential} to propose the language influence Index (LII) model.Language Influence Index (LII) selects 14 indicators to measure the influence of language from 5 aspects. The 14 indicators we choose are as follows:
